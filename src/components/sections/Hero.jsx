  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      intro
        ...
        .from('[data-layer="mtn-far"]', { opacity: 0, y: 30, duration: 1.5 }, 0.35)
        .from('[data-layer="mtn-near"]', { opacity: 0, y: 34, duration: 1.5 }, 0.45)
      ...
      mm.add(
        ...
        (context) => {
          ...
          tl.to('[data-layer="sky"]', { yPercent: 6 }, 0)
            ...
            .to('[data-layer="mtn-far"]', { yPercent: 24 }, 0)
            .to('[data-layer="mtn-near"]', { yPercent: 36 }, 0)
